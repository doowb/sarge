# Contributing to search-indexer

First and foremost, thank you! We appreciate that you want to contribute to search-indexer, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for search-indexer**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for search-indexer:

- star the [project](https://github.com/doowb/search-indexer)
- tweet your support for search-indexer
...
- **version**: please note the version of search-indexer are you using
...
[so]: http://stackoverflow.com/questions/tagged/search-indexer